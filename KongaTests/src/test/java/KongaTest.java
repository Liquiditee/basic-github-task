...
public class KongaTest {
    ...
    public void setup() throws InterruptedException {
        ...
        //3. Verify that the url is correct and user is on the right webpage
    ...
    public void SignIn() throws InterruptedException {
        ...
        driver.findElement(By.id("username")).sendKeys("thesmalls4u@gmail.com");
        //7. Enter password
        driver.findElement(By.id("password")).sendKeys("Akpobosu123");
        Thread.sleep(3000);
        //8. Click on Login
    ...
    public void AddToCart() throws InterruptedException {
        //Finding / Adding a Macbook to the cart
    ...
    public void SelectCard() throws InterruptedException {
        ...
        //23.Locate the card number field and enter an invalid card number
        WebElement CardNumberField = driver.findElement(By.id("card-number"));
        CardNumberField.sendKeys("5399834471129226");
        Thread.sleep(2000);


        //24. Locate the date-field and enter an invalid date
        WebElement DateField = driver.findElement(By.id("expiry"));
        DateField.sendKeys("1223");
        Thread.sleep(2000);


        //25. Locate the CVV field and enter an invalid CVV
        WebElement CVVField = driver.findElement(By.id("cvv"));
        CVVField.sendKeys("020");
